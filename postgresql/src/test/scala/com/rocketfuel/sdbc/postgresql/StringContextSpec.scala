...
class StringContextSpec extends FunSuite {
  ...
  test("Boolean interpolation works with execute") {
    ...
    assertResult(Map("0" -> ParameterValue.of(b)))(e.parameterValues)
  }
  ...
  test("Boxed Boolean interpolation works with execute") {
    ...
    assertResult(Map("0" -> ParameterValue.of(b.booleanValue())))(e.parameterValues)
  }
  ...
  test("Scala BigDecimal interpolation works with execute") {
    ...
    assertResult(Map("0" -> ParameterValue.of(d)))(e.parameterValues)
  }
  ...
  test("Double interpolation works with execute") {
    ...
    assertResult(Map("0" -> ParameterValue.of(i)))(e.parameterValues)
  }
  ...
  test("String interpolation works with execute") {
    ...
    assertResult(Map("0" -> ParameterValue.of(s)))(e.parameterValues)
  }
  ...
  test("Time interpolation works with execute") {
    ...
    assertResult(Map("0" -> ParameterValue.of(t)))(e.parameterValues)
  }
